...
from preprocessor import get_data_filepath, EXP_DIR,  REPO_DIR, WIKI_DOC, D_WIKI, MED_DOC
...
def evaluate_on_MED_DOC(phase, features_kwargs=None,  model_dirname = None):
    dataset = MED_DOC
...
####### MED_DOC #######
evaluate_on_MED_DOC(phase='test', features_kwargs=None, model_dirname=model_dirname)